...
(function (document) {
	...
	function injectCSS() {
		...
		css += '.paypal-button-content { height: 11px; padding: 8px; font-size: 10px !important; line-height: 12px !important; }';
