...
(function (document) {
	...
	function injectCSS() {
		...
		css += '.medium .paypal-button-logo img { width: 22px; height: 22px; margin: 4px 0 0 -2px; }';
		css += '.medium .paypal-button-content { height: 13px; font-size: 10px !important; line-height: 13px !important; }';
		css += '.medium .paypal-button-content img { width: 71px; height: 19px; }';

		// Large
		css += '.large .paypal-button-logo { width: 45px; height: 44px; }';
		css += '.large .paypal-button-logo img { width: 30px; height: 30px; margin: 8px 0 0 -2px; }';
		css += '.large .paypal-button-content { height: 28px; padding: 9px 8px 7px; font-size: 13px !important; line-height: 28px !important; }';
		css += '.large .paypal-button-content img { width: 93px; height: 25px; }';
	...
	function buildForm(data, type) {
		...
		btnContent.innerHTML = btnText.replace('{wordmark}', '<img src="' + wordmark[btnStyle] + '" />');
