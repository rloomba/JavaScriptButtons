...
(function (document) {
    ...
    function injectCSS() {
        ...
        css += '.paypal-button-content img { width: 60px; height: 16px; margin: 1px 0 0 1px; }';
        ...
        css += '.paypal-button.medium .paypal-button-content img { width: 71px; height: 19px; margin: 2px 0 0 1px; }';
        ...
        css += '.paypal-button.large .paypal-button-content img { width: 93px; height: 25px; margin: 2px 0 0 2px; }';
